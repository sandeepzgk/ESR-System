    ...
    <div className="mb-4">
      ...
      {signalType === 'noise' && noiseBandwidth && (
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          <h3 className="text-md font-medium mb-2">Noise Bandwidth Analysis</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white p-3 rounded shadow">
              <div className="text-sm text-gray-600">Minimum Frequency:</div>
              <div className="text-lg font-semibold">{noiseBandwidth.min.toFixed(2)} Hz</div>
            </div>
            <div className="bg-white p-3 rounded shadow">
              <div className="text-sm text-gray-600">Maximum Frequency:</div>
              <div className="text-lg font-semibold">{noiseBandwidth.max.toFixed(2)} Hz</div>
            </div>
            <div className="bg-white p-3 rounded shadow">
              <div className="text-sm text-gray-600">Bandwidth:</div>
              <div className="text-lg font-semibold">{(noiseBandwidth.max - noiseBandwidth.min).toFixed(2)} Hz</div>
            </div>
            <div className="bg-white p-3 rounded shadow">
              <div className="text-sm text-gray-600">Center Frequency:</div>
              <div className="text-lg font-semibold">{((noiseBandwidth.max + noiseBandwidth.min) / 2).toFixed(2)} Hz</div>
            </div>
          </div>
