...
const ParameterControl = ({ 
  ...
  const getLabel = () => {
    if (paramName === 'safeCurrentThreshold') return 'Safe Current Threshold';
    ...
    <>
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <div className="bg-white p-4 rounded shadow mb-4">
          ...
          <p>Total current: I = I_R + I_C = V₍rms₎/R + V₍rms₎(2πfC)</p>
          <p>Where V₍rms₎ = V₍pp₎/(2√2) for sine waves</p>
          <p>The dimensionless parameter ωRC = {wRC.toFixed(4)} determines circuit behavior</p>
        </div>
        
        <div className="bg-white p-4 rounded shadow mb-4">
          <h3 className="font-medium mb-2">Regime Analysis:</h3>
          <ul className="list-disc pl-5">
            <li><strong>ωRC &lt; 1:</strong> Resistive regime (current primarily flows through resistor)</li>
            <li><strong>ωRC = 1:</strong> Transition point (equal current through both components)</li>
            <li><strong>ωRC &gt; 1:</strong> Capacitive regime (current primarily flows through capacitor)</li>
            <li><strong>Current Status:</strong> Operating in {determineRegime()} regime with ωRC = {wRC.toFixed(4)}</li>
          </ul>
        </div>
